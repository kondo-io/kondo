...
def test_detect_repository_type_python():
    ...
    assert detect_repository_type(os.getcwd() + '/fixtures/sample-python-project') == "python"


def test_detect_repository_type_terraform():
    """Ensure detector properly returns terraform for terraform project"""
    assert detect_repository_type(os.getcwd() + '/fixtures/sample-terraform-project') == "terraform"
